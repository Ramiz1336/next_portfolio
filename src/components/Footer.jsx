...
const Footer = () => {
  const handleTwitterRedirecting = () => {
    window.open("https://x.com/Ramiz1336", "_blank");
  };

  const handleInstagramRedirecting = () => {
    window.open("https://www.instagram.com/stark_ramiz/", "_blank");
  };

  const handleLinkedinRedirecting = () => {
    window.open("https://www.linkedin.com/in/sk-ramiz-raja-8a72651b6/", "_blank");
  };

  const handleGithubRedirecting = () => {
    window.open("https://github.com/Ramiz1336/", "_blank");
  };

  const handleUpworkRedirecting = () => {
    window.open("https://www.upwork.com/freelancers/~013980cb1be32c3f65?mp_source=share/", "_blank");
  };
